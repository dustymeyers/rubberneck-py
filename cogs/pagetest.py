...
class PageTest(commands.Cog):
    ...
    def __init__(self, bot: Bot):
        ...
        self.__pages = [
            "Page 1",
            [
                Embed(title="Page 2, Embed 1"),
                Embed(title="Page 2, Embed 2"),
            ],
            "Page Three",
            Embed(title="Page Four"),
            Embed(
                title="Page Five",
                fields=[
                    EmbedField(
            ...
            [
                Embed(title="Page Six, Embed 1"),
                Embed(title="Page Seven, Embed 2"),
            ],
        ]
        self.__pages[3].set_image(
            url="https://c.tenor.com/pPKOYQpTO8AAAAAM/monkey-developer.gif"
        )
        self.__pages[4].add_field(
        ...
        self.new_pages = [
            Page(
                ...
                embeds=[
                    Embed(title="New Page 1 Embed Title 1!"),
                    Embed(title="New Page 1 Embed Title 2!"),
                ],
            ),
            Page(
                content="Page 2 Title!",
                embeds=[
                    Embed(title="New Page 2 Embed Title 1!"),
                    Embed(title="New Page 2 Embed Title 2!"),
                ],
            ),
        ]
    ...
    async def pagetest_new(self, ctx: discord.ApplicationContext):
        ...
        paginator = Paginator(pages=self.new_pages)
        await paginator.respond(ctx.interaction, ephemeral=False)
    ...
    async def pagetest_hidden(self, ctx: discord.ApplicationContext):
        ...
        paginator = Paginator(pages=self.get_pages(), show_disabled=False)
        await paginator.respond(ctx.interaction, ephemeral=False)
    ...
    async def pagetest_loop(self, ctx: discord.ApplicationContext):
        ...
        paginator = Paginator(pages=self.get_pages(), loop_pages=True)
        await paginator.respond(ctx.interaction, ephemeral=False)
    ...
    async def pagetest_custom_view(self, ctx: discord.ApplicationContext):
        ...
        paginator = Paginator(pages=self.get_pages(), custom_view=view)
        await paginator.respond(ctx.interaction, ephemeral=False)
    ...
    async def pagetest_prefix(self, ctx: commands.Context):
        ...
        paginator = Paginator(pages=self.get_pages(), use_default_buttons=False)
        paginator.add_button(
            PaginatorButton("prev", label="<", style=discord.ButtonStyle.green)
        )
        paginator.add_button(
        ...
        paginator.add_button(
            PaginatorButton("next", style=discord.ButtonStyle.green)
        )
